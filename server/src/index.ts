...
// Serve uploaded files statically. The bytes are user-supplied, so tell
// browsers to take the Content-Type at face value instead of sniffing their
// way to a more dangerous interpretation of the same file.
app.use(
  '/uploads',
